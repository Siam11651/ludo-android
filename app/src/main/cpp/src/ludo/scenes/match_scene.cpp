...
ludo::stars_object::stars_object(ludo::scene *_scene) : gameobject(_scene)
{
    for(size_t i = 0; i < 2; ++i)
    {
        ...
        m_stars[i]->sprite_ptr = new ludo::sprite("star.png");
...
ludo::match_scene::match_scene() : scene(), m_coin_move_duration(250000000)
{
    ...
    m_board_sprite.setup_sprite("board.png");
    m_coin_sprites[0].setup_sprite("coins/coin_red.png");
    m_coin_sprites[1].setup_sprite("coins/coin_blue.png");
    m_coin_sprites[2].setup_sprite("coins/coin_yellow.png");
    m_coin_sprites[3].setup_sprite("coins/coin_green.png");
        ...
        if(legal_moves_count > 0)
        {
            for(size_t i = 0; i < 4; ++i)
            {
                if(!legal_moves[i].empty() && clicked)
                {
                    ...
                    const glm::mat4x4 &rotation_mat = glm::mat4_cast(cam_rotation);
